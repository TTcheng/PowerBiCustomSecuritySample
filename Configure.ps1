...
Copy-Item -Path Logon.aspx -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\"

Write-Host "Copying Microsoft.Samples.ReportingServices.CustomSecurity.dll `n" -ForegroundColor Green
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\Bin\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\Portal\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\PowerBi"

Write-Host "Copying Microsoft.Samples.ReportingServices.CustomSecurity.dll.config `n" -ForegroundColor Green
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll.config -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\Bin\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll.config -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\Portal\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.dll.config -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\PowerBi"

Write-Host "Copying Microsoft.Samples.ReportingServices.CustomSecurity.pdb `n" -ForegroundColor Green
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.pdb -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\Bin\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.pdb -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\Portal\"
Copy-Item -Path Microsoft.Samples.ReportingServices.CustomSecurity.pdb -Destination "D:\Program Files\Microsoft Power BI Report Server\PBIRS\PowerBi"

Write-Host "Updating rsreportserver.config `n" -ForegroundColor Green
$rsConfigFilePath = "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\rsreportserver.config"
...
$rsPolicyFilePath = "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\rssrvpolicy.config"
...
$codeGroup.InnerXml ="<IMembershipCondition class=""UrlMembershipCondition"" version=""1"" Url=""D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\bin\Microsoft.Samples.ReportingServices.CustomSecurity.dll""/>"
...
$webConfigFilePath = "D:\Program Files\Microsoft Power BI Report Server\PBIRS\ReportServer\web.config"
